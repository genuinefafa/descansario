  ...
  {#if showDeleteDialog}
    ...
    >
      <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <p class="text-sm text-red-600 font-semibold mb-4">Esta acción no se puede deshacer.</p>
    ...
    {#if holidays.length === 0}
      <div class="p-8 text-center text-gray-500">
        ...
        <p class="text-sm mt-2">
          {onSync
            ? 'Usa el botón "Sincronizar" o agrega uno manualmente'
            : 'Comienza agregando un nuevo feriado'}
        </p>
      </div>
    {:else}
